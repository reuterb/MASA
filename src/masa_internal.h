...
namespace MASA
{
   ...
   */
    ...
    virtual Scalar eval_exact_drho(Scalar,Scalar,Scalar,Scalar)    {std::cout << "MASA ERROR:: Analytical Solution (drho) is unavailable or not properly loaded.\n"; return -1.33;};
   ...
   */
    ...
    virtual Scalar eval_q_zMc(Scalar,Scalar,Scalar,Scalar){std::cout << "MASA ERROR:: Source Term (Z) is unavailable or not properly loaded.\n"; return -1.33;};  // overloaded for 4d problems
    ...
    virtual Scalar eval_q_m3Top(Scalar,Scalar,Scalar,Scalar){std::cout << "MASA ERROR:: Source Term (m3Top) is unavailable or not properly loaded.\n"; return -1.33;};  // overloaded for 4d problems
    virtual Scalar eval_q_m1Bottom(Scalar,Scalar,Scalar,Scalar){std::cout << "MASA ERROR:: Source Term (m1Bottom) is unavailable or not properly loaded.\n"; return -1.33;};  // overloaded for 4d problems
    virtual Scalar eval_q_m3Bottom(Scalar,Scalar,Scalar,Scalar){std::cout << "MASA ERROR:: Source Term (m3Bottom) is unavailable or not properly loaded.\n"; return -1.33;};  // overloaded for 4d problems
    ...
    virtual Scalar eval_q_phiBottom(Scalar,Scalar,Scalar,Scalar){std::cout << "MASA ERROR:: Source Term (bottom) is unavailable or not properly loaded.\n"; return -1.33;};  // overloaded for 4d problems
...
public:
  ...
  Scalar eval_q_rho  (Scalar,Scalar,Scalar,Scalar);
  Scalar eval_q_z  (Scalar,Scalar,Scalar,Scalar);
  Scalar eval_q_zMc(Scalar,Scalar,Scalar,Scalar);
  Scalar eval_q_p  (Scalar,Scalar,Scalar,Scalar);
  Scalar eval_q_pBound  (Scalar,Scalar,Scalar,Scalar);
  Scalar eval_q_m1(Scalar,Scalar,Scalar,Scalar);
  Scalar eval_q_m3(Scalar,Scalar,Scalar,Scalar);
